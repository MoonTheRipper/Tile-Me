...
- v1.0.2 ships built-in layouts only; there is no dynamic freeform tiling editor yet
...
- fullscreen-style behavior is implemented as visible-frame maximize placement in v1.0.2
